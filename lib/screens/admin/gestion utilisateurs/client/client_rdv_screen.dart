...
class ClientRdvScreen extends StatefulWidget {
  ...
  const ClientRdvScreen({super.key, required this.uid, required this.username});
    ...
    try {
      final snapshot =
          await _firestore
              ...
              .where('client_uid', isEqualTo: widget.uid)
              .get();
                          ...
                          CircleAvatar(
                            ...
                            backgroundImage:
                                rdv.prestataireProfilePicture.isNotEmpty
                                    ...
                                    : null,
                            child:
                                rdv.prestataireProfilePicture.isEmpty
                                    ? const Icon(
                                      Icons.person,
                                      color: Colors.white,
                                    )
